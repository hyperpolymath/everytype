...
;;
;; Guix package definition for anytype
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace anytype and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/anytype")
  (synopsis "The reference type-checker kernel that implements systemet (Equality Theory).")
